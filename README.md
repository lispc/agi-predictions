...
| **watch/** | 月度观察双刊：`capability/`（METR 基准、模型与收入、capex、预测市场）+ `macro/`（美债、利率、流动性）——互相校准泡沫情景与时间线概率 | [capability 首期](watch/capability/2026-08-27-ai-timeline-watch.md) ｜ [macro 美债观察](watch/macro/2026-08-26-us-debt-crisis-watch.md) |
...
- **金融**：晚期泡沫、真实盈利、循环融资是阿喀琉斯之踵。情景 A 破裂 50%（窗口 2026-10 ~ 2027-03）；但 8/26 NVDA 财报大超预期，破裂信号首检未触发，证据结构暂偏 B/C（见 watch/capability 首期）。
